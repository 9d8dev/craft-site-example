		...
		<Craft.Main>
			<Craft.Section className="border-b">
				<Craft.Container>
					...
					<h2>
						<Balancer>
							Craft UI is a design system for NextJS Websites. It is built using shadcn/ui, radix
							ui, and tailwindcss.
						</Balancer>
					</h2>
			...
			<Craft.Section className="border-b">
				<Craft.Container>
					...
					<p className="mb-0">
						This is a paragraph with an <a href="/">inline link</a>. Lorem ipsum dolor sit amet,
						consectetur adipiscing elit. Nulla nec justo eget justo cursus ornare. Lorem ipsum dolor
						sit amet, consectetur adipiscing elit. Nulla nec justo eget justo cursus ornare. Lorem
						ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec justo eget justo cursus
						ornare.
					</p>
				</Craft.Container>
			</Craft.Section>
			...
			<Craft.Section>
				<Craft.Container>
					<Craft.Article>
						<h2 className="mt-0">
							<Balancer>This is an example of the {'<Craft.Article/>'} Component</Balancer>
						</h2>
						<p>
